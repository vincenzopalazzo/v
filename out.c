	...
	#define V_COMMIT_HASH "9de0c72"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "417a6dc"
#endif
...
VV_LOCAL_SYMBOL string strconv__f64_to_str_lnd1(f64 f, int dec_digit);
...
VV_LOCAL_SYMBOL int compare_16897382378628231393_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
VV_LOCAL_SYMBOL void main__insert_helper(main__Foo* node);
...
int math__bits__trailing_zeros_16(u16 x) {
	...
	int _t2 = ((int)((*(u8*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((u32)((x & -x))) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_32(u32 x) {
	...
	int _t2 = ((int)((*(u8*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn32tab, ((x & -x)) * _const_math__bits__de_bruijn32 >> (27)))));
	return _t2;
}
...
int math__bits__trailing_zeros_64(u64 x) {
	...
	int _t2 = ((int)((*(u8*)/*ee elem_sym */array_get(_const_math__bits__de_bruijn64tab, ((x & -x)) * _const_math__bits__de_bruijn64 >> (58)))));
	return _t2;
}
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_16897382378628231393_RepIndex_by_idx);
	u8* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
